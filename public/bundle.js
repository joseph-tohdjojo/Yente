angular.module('yente', ['ui.router']).config(function ($stateProvider, $urlRouterProvider) {
...
(function () {
    ...
    $.fn.cloudGrid = function (gridArgs) {
        if (typeof arguments[0] === 'string') {
            ...
            this.each(function () {
                ...
                if (grid) {
                    grid[gridArgs].apply(grid, Array.prototype.slice.call(_arguments, 1));
                }
            });
        } else {
            this.each(function () {
    ...
    CloudGrid.prototype._setChildProperties = function (child, childIndex) {
        ...
        var properties = {
            width: this._getDimensionFromSize($.data(child, gridColumnAttr) || $(child).attr('data-' + gridColumnAttr)) || 1,
            height: this._getDimensionFromSize($.data(child, gridRowsAttr) || $(child).attr('data-' + gridRowsAttr)) || 1
        };
...
angular.module('yente').controller('cloudGridController', function ($scope) {
	var $element;
	var children = [];
...
angular.module('yente').component('cloudGrid', {
	templateUrl: './components/cloudgrid/cloudgrid-tmpl.html',
	controller: 'cloudGridController'
});
angular.module('yente').controller('sideNavController', function ($scope) {});
